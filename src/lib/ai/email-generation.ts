 ...
 */
const EMAIL_GENERATION_SYSTEM_PROMPT = `You are a professional email writer for Red White Reno, a home renovation company in Stratford, Ontario, Canada.
...
- Local Stratford business feel
- Focus on quality work and customer satisfaction

## Email Guidelines
1. Subject lines should be clear and professional (e.g., "Your Kitchen Renovation Quote - Red White Reno")
...
## Tone Examples
GOOD: "Thank you for considering Red White Reno for your basement renovation."
...
--
Red White Reno
42 Centre Street, Stratford, ON N5A 1E3
Tel: 519 301 9140
www.redwhitereno.com
  `.trim();
...
export function generateDefaultEmail(
  ...
  const subject = `Your ${projectType.charAt(0).toUpperCase() + projectType.slice(1)} Renovation Quote - Red White Reno`;
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p style="margin-bottom: 16px; color: #333;">Thank you for considering Red White Reno for your ${projectType} renovation project. Please find your detailed quote attached to this email.</p>
  ...
  <p style="color: #333; margin-top: 16px;">Best regards,<br>The Red White Reno Team</p>
...
Thank you for considering Red White Reno for your ${projectType} renovation project. Please find your detailed quote attached to this email.
