 ...
 * Professional PDF matching Red White Reno's invoice format
      ...
      <Page size="LETTER" style={styles.page}>
        ...
        <View style={styles.customerWorkRow}>
          ...
          <View style={styles.paymentSection}>
            ...
            <Text style={styles.cellText}>E-Transfer: payments@redwhitereno.ca</Text>
          </View>
        </View>
        ...
        <View style={styles.bottomSection}>
          <View style={styles.termsSection}>
            ...
            <Text style={styles.termsText}>
              E-Transfer payments to: payments@redwhitereno.ca
            </Text>
            {payments.length > 0 && (
              <>
