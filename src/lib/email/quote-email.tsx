...
export function QuoteEmailTemplate({ lead, quote, customMessage }: QuoteEmailProps) {
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Your quote from Red White Reno - {formatCurrency(quote.total || 0)} for your {projectType.toLowerCase()}
      </Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={contentSection}>
            ...
            <Text style={paragraph}>
              Thank you for considering Red White Reno for your {projectType.toLowerCase()}.
            ...
            <Section style={ctaSection}>
              <Button href="mailto:quotes@redwhitereno.ca" style={ctaButton}>
                Reply to This Quote
              </Button>
            </Section>
          </Section>
          ...
          <Section style={footerSection}>
            ...
            <Text style={footerText}>
              <Link href="mailto:quotes@redwhitereno.ca" style={footerLink}>
                quotes@redwhitereno.ca
              </Link>
              {' '}&bull;{' '}
