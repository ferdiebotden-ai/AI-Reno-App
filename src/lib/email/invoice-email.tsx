...
export function InvoiceEmailTemplate({ invoice, customMessage }: InvoiceEmailProps) {
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Invoice #{invoice.invoice_number} from Red White Reno - {formatCurrency(total)}
      </Preview>
      <Body style={main}>
        <Container style={container}>
          {/* Header */}
          <Section style={headerSection}>
            <Text style={brandName}>Red White Reno</Text>
            <Text style={tagline}>Quality Renovations in Stratford, Ontario</Text>
          </Section>
          ...
          <Section style={contentSection}>
            ...
            <Text style={paragraph}>
              Please find attached your invoice from Red White Reno for your renovation project.
            </Text>
            ...
            <Text style={paragraph}>
              Payment can be made via E-Transfer to <strong>payments@redwhitereno.ca</strong>.
              Cheques payable to Red White Reno Inc.
            </Text>

            <Section style={ctaSection}>
              <Button href="mailto:invoices@redwhitereno.ca" style={ctaButton}>
          ...
          <Section style={footerSection}>
            <Text style={footerText}>
              Red White Reno | Stratford, Ontario
            </Text>
            <Text style={footerText}>
              <Link href="mailto:invoices@redwhitereno.ca" style={footerLink}>
                invoices@redwhitereno.ca
              </Link>
              {' '}&bull;{' '}
