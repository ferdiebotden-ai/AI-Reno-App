...
export async function POST(
  ...
  try {
    ...
    const emailBody = [
      ...
      '',
      custom_message ? `Note from Red White Reno: ${custom_message}\n` : '',
      'Payment can be made via E-Transfer to payments@redwhitereno.ca',
      '',
      'Thank you for choosing Red White Reno!',
      '',
      'Red White Reno Inc.',
    ...
    const emailResponse = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'Red White Reno <invoices@redwhitereno.ca>',
        to: [to_email],
        subject: `Invoice #${invoice.invoice_number} from Red White Reno`,
        text: emailBody,
        attachments: [
          {
