...
export function SessionResumeEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Continue your renovation quote with Red White Reno</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={footer}>
            Red White Reno - Quality Renovations in Stratford, ON
            <br />
            <Link href="https://redwhitereno.ca" style={footerLink}>
              redwhitereno.ca
            </Link>
          </Text>
        </Container>
