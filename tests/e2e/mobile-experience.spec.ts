...
test.describe('Mobile Navigation', () => {
  ...
  test('displays mobile menu button', async ({ page, isMobile }) => {
...
test.describe('Mobile Layout', () => {
  test('hero section displays correctly on mobile', async ({ page, isMobile }) => {
    test.skip(!isMobile, 'Mobile-only test');
  ...
  test('primary CTA is in thumb zone', async ({ page, isMobile }) => {
    test.skip(!isMobile, 'Mobile-only test');
...
test.describe('Touch Targets', () => {
  test('navigation buttons meet minimum touch target size', async ({ page, isMobile }) => {
    test.skip(!isMobile, 'Mobile-only test');
  ...
  test('CTA buttons meet minimum touch target size', async ({ page, isMobile }) => {
    test.skip(!isMobile, 'Mobile-only test');
...
test.describe('Mobile Form Experience', () => {
  ...
  test('estimate chat interface is mobile-friendly', async ({ page, isMobile }) => {
    test.skip(!isMobile, 'Mobile-only test');
    ...
    // Chat interface should be visible and full width
...
test.describe('Responsive Images', () => {
  test('images load on mobile viewport', async ({ page, isMobile }) => {
    test.skip(!isMobile, 'Mobile-only test');
...
test.describe('Mobile Visualizer', () => {
  test('visualizer page works on mobile', async ({ page, isMobile }) => {
    test.skip(!isMobile, 'Mobile-only test');
